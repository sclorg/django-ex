...
class TestDjangoAppExTemplate:
    ...
    def setup_method(self):
        ...
        self.oc_api.import_is(path=json_raw_file, name="python", skip_check=True)
    ...
    def test_template_inside_cluster(self):
        ...
        assert self.oc_api.deploy_template(
            ...
            openshift_args=[f"SOURCE_REPOSITORY_REF={branch_to_test}", f"PYTHON_VERSION={VERSION}", "NAME=django-example"]
        )
